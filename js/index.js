var arrNum = [ 10,17,18,24,31,35,42,-2,-9,-4,-1,-12,];
...
document.getElementById('ketquabai9').innerHTML = " Có tổng cộng " + sum + " số nguyên";
}
// bai 10: 
...
for (var i = 0; i < arrNum2.length; i++) {
  ...
  if(soDuong > soAm ){
    document.getElementById('ketquabai10').innerHTML = " Số dương có " + soDuong + " > " + " số âm  có " + soAm; 
  }
  else{
    document.getElementById('ketquabai10').innerHTML = " Số âm có " + soAm + " > " + " số dương có " + soDuong; 
  }
}
